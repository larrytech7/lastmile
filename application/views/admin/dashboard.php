          ...
          <section class="col-lg-12 connectedSortable">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?= $this->lang->line('franchises') ?></h3>
                <a href="#" data-target="#addfranchise" data-toggle="modal" class="float-right btn btn-primary" data-toggle="popup" data-title="<?= $this->lang->line('add_franchise') ?>"><i class="fas fa-plus-square"></i></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="franchises" class="table table-bordered table-striped">
                  ...
                  <?php foreach($franchises as $franchise ): ?>
                    <?php if($franchise['role_name'] == 'RESELLER'): ?>
                    <tr>
                      <td><?= $franchise['username'] ?></td>
                      <td><?= $franchise['name'] ?></td>
                      <td><?= $franchise['user_phone_number'] ?></td>
                      <td><?= $franchise['email'] ?></td>
                      <td><?= $franchise['user_status'] ?></td>
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          <a href="<?= site_url('dashboard/user/view/'.$franchise['user_id']) ?>" class="btn btn-info"><i class="fas fa-eye"></i></a>
                          <a href="<?= site_url('dashboard/user/view/'.$franchise['user_id']) ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                          <a href="<?= site_url('dashboard/user/delete/'.$franchise['user_id']) ?>" class="btn btn-danger" onclick="javascript:return confirm('<?= $this->lang->line('confirm_delete')?>')"><i class="fas fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                    <?php endif ?>
