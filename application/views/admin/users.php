  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?= $this->lang->line('users') ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <section class="col-lg-12 connectedSortable">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?= $this->lang->line('users') ?></h3>
                <a href="#" data-target="#adduser" data-toggle="modal" class="float-right btn btn-primary" title="<?= $this->lang->line('add_user') ?>"><i class="fas fa-user-plus"></i></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          <a href="<?= site_url('dashboard/user/view/'.$user['user_id']) ?>" class="btn btn-info"><i class="fas fa-eye"></i></a>
                          <a href="<?= site_url('dashboard/user/view/'.$user['user_id']) ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                          <a href="<?= site_url('dashboard/user/delete/'.$user['user_id']) ?>" class="btn btn-danger" onclick="javascript:return confirm('<?= $this->lang->line('confirm_delete')?>')"><i class="fas fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                    <?php endif ?>
